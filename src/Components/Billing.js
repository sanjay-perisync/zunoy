...
import { saveBillingAddress } from "../Redux/Slices/Billing/billingSlice";
...
function Billing() {
  ...
  const [localBillingData, setLocalBillingData] = useState(null);
  ...
  useEffect(() => {
    if (billingInfo) {
      setLocalBillingData(billingInfo);
      setFormData({
            ...
            {!showForm ? (
              localBillingData ? (
                <div className="">
                  {[
                    {
                      label: "Address Line 1", value: localBillingData.line1, icon: (
                    ...
                    {
                      label: "Address Line 2", value: localBillingData.line2, icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                          <path fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" d="M15.29 20.663h3.017a2.194 2.194 0 0 0 2.193-2.194v-6.454a3.3 3.3 0 0 0-1.13-2.48l-5.93-5.166a2.194 2.194 0 0 0-2.88 0L4.63 9.534a3.3 3.3 0 0 0-1.13 2.481v6.454c0 1.212.982 2.194 2.194 2.194h3.29m6.306 0v-6.581c0-.908-.736-1.645-1.645-1.645H10.63c-.909 0-1.645.737-1.645 1.645v6.581m6.306 0H8.984" />
                        </svg>
                      )
                    ...
                    {
                      label: "State", value: localBillingData.state, icon: (
                    ...
                    {
                      label: "City", value: localBillingData.city, icon: (
                    ...
                    {
                      label: "Pin code", value: localBillingData.postalCode, icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                          <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M256 48c-79.5 0-144 61.39-144 137c0 87 96 224.87 131.25 272.49a15.77 15.77 0 0 0 25.5 0C304 409.89 400 272.07 400 185c0-75.61-64.5-137-144-137" />
                          <circle cx="256" cy="192" r="48" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" />
                        </svg>
                    ...
                    {
                      label: "Country", value: localBillingData.country, icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                          <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M256 48c-79.5 0-144 61.39-144 137c0 87 96 224.87 131.25 272.49a15.77 15.77 0 0 0 25.5 0C304 409.89 400 272.07 400 185c0-75.61-64.5-137-144-137" />
                          <circle cx="256" cy="192" r="48" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" />
                        </svg>
                    ...
                    localBillingData.gstNumber && {
                      label: "GST Number", value: localBillingData.gstNumber, icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                          <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M256 48c-79.5 0-144 61.39-144 137c0 87 96 224.87 131.25 272.49a15.77 15.77 0 0 0 25.5 0C304 409.89 400 272.07 400 185c0-75.61-64.5-137-144-137" />
                          <circle cx="256" cy="192" r="48" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" />
                        </svg>
              ...
              : (
                <form onSubmit={handleUpdate}>
                  ...
                  <div className="flex justify-end mt-4 gap-4 p-4">
                    ...
                    <button
                      type="submit"
                      className={`ml-2 bg-indigo-500 px-3 py-[6px] text-white font-semibold rounded-xl ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-indigo-600'}`}
                      disabled={loading}
                    >
